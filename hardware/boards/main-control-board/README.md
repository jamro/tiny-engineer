...
- **Status:** draft
- **KiCad:** 10
- **Interfaces:** header sockets for the Waveshare ESP32-C3-Zero, Adafruit PCA9685, MAX98357A, SSD1306 OLED, Adafruit 5993 USB-C breakout, and five servo 3-pin plugs; shared I2C, I2S, +5V, 3V3, and GND
