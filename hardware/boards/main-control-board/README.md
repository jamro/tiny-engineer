...
- **ERC / DRC:** schematic ERC after the symbol pass. PCB is routed with custom power DRC in `[main-control-board.kicad_dru](main-control-board.kicad_dru)`; DRC not signed off for fab.
